# 10. ROS2-AI Large Model Courses
...
<img class="common_img" src="../_static/media/chapter_10/section_1.1/02/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_10/section_1.1/02/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_10/section_1.1/02/image12.png"  />
...
Source Code Path: [/home/ubuntu/large_models/wakeup_demo.py](../_static/source_code/10/wakeup_demo.zip)
...
The program source code is located at: [/home/ubuntu/large_models/openai_asr_demo.py](../_static/source_code/10/openai_asr_demo.zip)
...
[/home/ubuntu/large_models/resources/audio/](../_static/source_code/10/audio.zip)
...
The source code for this program is located at:  [/home/ubuntu/large_models/openai_tts_demo.py](../_static/source_code/10/openai_tts_demo.zip)
...
The source code for this program is located at: [/home/ubuntu/large_models/openai_interaction_demo.py](../_static/source_code/10/openai_interaciton_demo.zip)
...
① Click on the path box to navigate to the following directory: [/home/ubuntu/large_models/resources/pictures/](../_static/source_code/10/pictures.zip)
...
① Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10/section_1/media/image1.png"  /> to access the configuration interface.

② First, verify the system language setting.

<img src="../_static/media/chapter_10/section_1/media/image2.png"  />

③ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10/section_1/media/image3.png"   />

<img src="../_static/media/chapter_10/section_1/media/image4.png"  />

④ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10/section_1/media/image5.png"  />

⑤ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10/section_1/media/image6.png"  />

⑥ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10/section_1/media/image7.png"  />
...
<img src="../_static/media/chapter_10/section_1/media/image9.png"  />
...
(1) Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10/section_1/media/image11.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
<img src="../_static/media/chapter_10/section_1/media/image14.png"  />
...
<img src="../_static/media/chapter_10/section_1/media/image15.png"  />
...
<img src="../_static/media/chapter_10/section_1/media/image16.png"  />
...
<img src="../_static/media/chapter_10/section_1/media/image17.png"  />
...
<img src="../_static/media/chapter_10/section_1/media/image18.png"  />
...
⑤ controller\_launch includes the Launch file controller.launch.py from the controller package using `IncludeLaunchDescription`.

⑥ large\_models_launch includes the Launch file start.launch.py from the large_models package using `IncludeLaunchDescription` and passes the mode argument to it.
...
[ros2_ws/src/large_models_examples/large_models_examples/llm_control_move.py]()
...
① Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10/section_2/media/image1.png"  /> to access the configuration interface.

② First, verify the system language setting.

<img src="../_static/media/chapter_10/section_2/media/image2.png"  />

③ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10/section_2/media/image3.png"   />

<img src="../_static/media/chapter_10/section_2/media/image4.png"  />

④ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10/section_2/media/image5.png"  />

⑤ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10/section_2/media/image6.png"  />

⑥ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10/section_2/media/image7.png"  />
...
<img src="../_static/media/chapter_10/section_2/media/image9.png"  />
...
(1) Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10/section_2/media/image11.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
<img src="../_static/media/chapter_10/section_2/media/image14.png"  />

(4) When the terminal displays the corresponding output shown in the figure and the device responds with "**I’m here**", it indicates successful activation. The system will begin recording the user’s voice command.

<img src="../_static/media/chapter_10/section_2/media/image15.png"  />
...
<img src="../_static/media/chapter_10/section_2/media/image16.png"  />
...
<img src="../_static/media/chapter_10/section_2/media/image17.png"  />

<img src="../_static/media/chapter_10/section_2/media/image18.png"  />
...
<img src="../_static/media/chapter_10/section_2/media/image19.png"  />
...
① Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10/section_3/media/image1.png"  /> to access the configuration interface.

② First, verify the system language setting.

<img src="../_static/media/chapter_10/section_3/media/image2.png"  />

③ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10/section_3/media/image3.png"  alt="麦克风" />

<img src="../_static/media/chapter_10/section_3/media/image4.png"  />

④ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10/section_3/media/image5.png"  />

⑤ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10/section_3/media/image6.png"  />

⑥ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10/section_3/media/image7.png"  />
...
<img src="../_static/media/chapter_10/section_3/media/image9.png"  />
...
(1) Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10/section_3/media/image11.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
<img src="../_static/media/chapter_10/section_3/media/image14.png"  />

(4) After the program has loaded successfully, the camera feed will appear on screen.

<img src="../_static/media/chapter_10/section_3/media/image15.png"  />
...
<img src="../_static/media/chapter_10/section_3/media/image16.png"  />
...
<img src="../_static/media/chapter_10/section_3/media/image17.png"  />
...
<img src="../_static/media/chapter_10/section_3/media/image18.png"  />

(8) Then, the robot will detect the red object in its camera feed and begin tracking it in real time.

<img src="../_static/media/chapter_10/section_3/media/image19.png"  />
...
<img src="../_static/media/chapter_10/section_3/media/image20.png"  />
...
<img src="../_static/media/chapter_10\section_4\01\media\image1.png" style="width:5.76181in;height:3.22986in" />
...
① Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10\section_4\02\media\image1.png"  /> to access the configuration interface.

② First, verify the system language setting.

<img src="../_static/media/chapter_10\section_4\02\media\image2.png"  />

③ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10\section_4\02\media\image3.png"   />

<img src="../_static/media/chapter_10\section_4\02\media\image4.png"  />

④ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10\section_4\02\media\image5.png"  />

⑤ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10\section_4\02\media\image6.png"  />

⑥ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10\section_4\02\media\image7.png"  />
...
<img src="../_static/media/chapter_10\section_4\02\media\image9.png"  />

* **Enabling and Disabling the Feature**

(1) Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10\section_4\02\media\image10.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
<img src="../_static/media/chapter_10\section_4\02\media\image13.png"  />

(4) When the terminal displays the corresponding output shown in the figure and the device responds with "**I’m Here**", it indicates successful activation. The system will begin recording the user’s voice command.

<img src="../_static/media/chapter_10\section_4\02\media\image14.png"  />
...
<img src="../_static/media/chapter_10\section_4\02\media\image15.png"  />
...
<img src="../_static/media/chapter_10\section_4\02\media\image16.png"  />

<img src="../_static/media/chapter_10\section_4\02\media\image17.png"  />
...
<img src="../_static/media/chapter_10\section_4\02\media\image19.png"  />
...
⑤ `controller_launch` includes the Launch file `controller.launch.py` from the large_models package using IncludeLaunchDescription and passes the mode argument to it.
...
⑰ l`arge_models_msgs.srv`: custom service types for large models.
...
④ Upon shutdown, the node is properly destroyed using `node.destroy`_node().
...
① Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10\section_4\03\media\image1.png"  /> to access the configuration interface.

② First, verify the system language setting.

<img src="../_static/media/chapter_10\section_4\03\media\image2.png"  />

③ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10\section_4\03\media\image3.png"   />

<img src="../_static/media/chapter_10\section_4\03\media\image4.png"  />

④ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10\section_4\03\media\image5.png"  />

⑤ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10\section_4\03\media\image6.png"  />

⑥ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10\section_4\03\media\image7.png"  />
...
<img src="../_static/media/chapter_10\section_4\03\media\image9.png"  />
...
(1) Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10\section_4\03\media\image11.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
<img src="../_static/media/chapter_10\section_4\03\media\image14.png"  />

<img src="../_static/media/chapter_10\section_4\03\media\image15.png"  />
...
<img src="../_static/media/chapter_10\section_4\03\media\image16.png"   />
...
<img src="../_static/media/chapter_10\section_4\03\media\image17.png"  />
...
<img src="../_static/media/chapter_10\section_4\03\media\image18.png"  />
...
③ Additionally, it includes the vllm_track executable from the large_models_examples package, which serves as the main node for the visual tracking functionality.
...
<img src="../_static/media/chapter_10\section_4\03\media\image35.png"  />
...
### 10.3.4_smart_home_assistant_in_embodied_ai_applications
...
② Log in to the machine remotely via NoMachine. Then click the desktop icon <img src="../_static/media/chapter_10\section_4\04\media\image1.png"  /> to access the configuration interface.

③ First, verify the system language setting.

<img src="../_static/media/chapter_10\section_4\04\media\image2.png"  />

④ For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_10\section_4\04\media\image3.png"  alt="麦克风" />

<img src="../_static/media/chapter_10\section_4\04\media\image4.png"  />

⑤ After making the appropriate selection, click **Save**.

<img src="../_static/media/chapter_10\section_4\04\media\image5.png"  />

⑥ A "**Save Success**" message will confirm that the configuration has been stored in the system environment.

<img src="../_static/media/chapter_10\section_4\04\media\image6.png"  />

⑦ Then, click **Quit** to close the interface.

<img src="../_static/media/chapter_10\section_4\04\media\image7.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image9.png"  />

* **Navigation Map Construction**

Before enabling this feature, a map must be created in advance. Please refer to [5.Mapping & Navigation course]() for detailed instructions on how to build the map.
...
① Open the command line terminal from the left side of the system interface.<img src="../_static/media/chapter_10\section_4\04\media\image11.png"  /> In the terminal window, enter the following command and press Enter to stop the auto-start service
...
③ Once rviz is launched with the map, click on the 2D Pose Estimate icon to initialize the robot's position and orientation based on its actual location on the map.

<img src="../_static/media/chapter_10\section_4\04\media\image14.png"  />

④ When the terminal displays the corresponding output shown in the figure and the device responds with "**I’m Here**", it indicates successful activation.

<img src="../_static/media/chapter_10\section_4\04\media\image15.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image16.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image17.png"  />

⑦ The robot will move to the designated "kitchen" location as defined in the program, detect whether the door is closed.<img src="../_static/media/chapter_10\section_4\04\media\image18.png"  />

⑧ Then return to the original position and state whether "the door is closed."

<img src="../_static/media/chapter_10\section_4\04\media\image19.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image20.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image21.png"  />
...
① Begin by launching the program and displaying the map in rviz following step 4 above. Then, click on "2D Goal Pose" in the rviz interface to set the desired navigation target on the map.

<img src="../_static/media/chapter_10\section_4\04\media\image22.png"  />

② Return to the terminal to view the published goal parameters. Once you obtain the target coordinates, you can fill in the x and y values and related parameters accordingly.

<img src="../_static/media/chapter_10\section_4\04\media\image23.png"  alt="企业微信截图_1746459925390" />
...
<img src="../_static/media/chapter_10\section_4\04\media\image24.png"  />
...
<img src="../_static/media/chapter_10\section_4\04\media\image25.png"  />
...
[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/navigation_controller.py]()
