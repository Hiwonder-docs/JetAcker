...
2)  Start the robot, and connect it to NoMachine according to the instructions provided in ‘**[1.6 Development Environment Setup]()**’.
...
1. Start the robot, and access the robot system desktop using NoMachine according to the tutorial saved in ‘**[1.6 Development Environment Setup]()**.’.
