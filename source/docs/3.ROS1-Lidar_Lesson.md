...
> [!NOTE]
>
> **The following instructions are based on G4 Lidar, and is also applicable to A1 Lidar.**
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image5.jpeg" style="width:300px"  />

**Right: G4 Lidar**

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image6.jpeg" style="width:300px"  />
...
2)  Start the robot, and connect it to NoMachine according to the instructions provided in '**[1. Getting Ready->1.6 Development Environment Setup and Configuration]( https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html#development-environment-setup-and-configuration)**'.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image7.png" style="width:500px" />

3)  After successful connection, double-click <img src="../_static/media/chapter_3/section_1/media/image8.png" style="width:50px"  />.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image9.png" style="width:500px" />

4)  Select “**A1**” Click-on Lidar TAB, and select “**A1**”, then click-on “**Save**” and “**Apply**” in sequence.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image10.png" style="width:500px" />

5)  After you reselect the Lidar version, the below prompt will appear.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image11.png" style="width:500px" />

6)  After you reselect the Lidar version, the below prompt will appear.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image12.png" style="width:500px" />

7)  Finally, click-on <img src="../_static/media/chapter_3/section_1/media/image13.png" style="width:50px" /> to confirm the Lidar version.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image14.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image15.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image16.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image17.png" style="width:500px"  />
...
For instructions on app connection, please consult the tutorial located in '**[1. Getting Ready/1.5 APP Control](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html#app-control)**'

For details on remote connection, please refer to the tutorial saved in '**[1. Getting Ready->1.6 Development Environment Setup and Configuration]( https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html#development-environment-setup-and-configuration)**.'

### 3.3.1 Initiate Lidar Game through App

1)  Connect the robot to WonderAi app.

2)  Click-on Lidar to navigate to the game interface.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image18.png" style="width:500px"  />

3)  Switch on '**Avoid obstacle**' button to start the game.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image19.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image20.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image21.png" style="width:500px" />

### 3.3.2 Initiate Lidar Game Using Command

1)  Start the robot, and access the robot system desktop using NoMachine according to the tutorial saved in '**[1. Getting Ready/ 1.6 Development Environment Setup and Configuration]( https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html#development-environment-setup-and-configuration)**'.

2)  Click-on <img src="../_static/media/chapter_3/section_1/media/image22.png" style="width:50px" /> to open the command line terminal.
...
> [!NOTE]
>
> **The robot's performance initiated by the app and command is identical. If you wish to access the source code, please find the file 'lidar.py' located in this folder: /ros_ws/src/hiwonder_app/scripts/**
...
### 3.4.1 Initiate Lidar Game through App

1)  Connect the robot to WonderAi app.

2)  Click-on Lidar to navigate to the game interface.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image28.png" style="width:500px" />

3)  Switch on '**Lidar following**' button to start the game.

<img class="common_img" src="../_static/media/chapter_3/section_1/media/image29.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image30.png" style="width:500px" />

### 3.4.2 Initiate Lidar Game Using Command
