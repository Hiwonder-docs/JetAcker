...
2)  Start the robot, and connect it to NoMachine according to the instructions provided in ‘**[1. Getting Ready->1.6 Development Environment Setup and Configuration]()**’.
...
For instructions on app connection, please consult the tutorial located in '**[1. Getting Ready/1.5 APP Control]()**'

For details on remote connection, please refer to the tutorial saved in '**[1. Getting Ready->1.6 Development Environment Setup and Configuration]()**.’
...
1)  Start the robot, and access the robot system desktop using NoMachine according to the tutorial saved in ‘**[1. Getting Ready/ 1.6 Development Environment Setup and Configuration]()**’.
