...
to learn about the type of the joint, please refer to "**[joint](#anchor_5_1_1_joint)**".
...
(2) Click-on <img src="../_static/media/chapter_5/section_1/image24.png"> to start the command-line terminal.
...
**The shadow part of the robot model (base_footprint)**

Defines the link "**base_footprint**" and the joint "**base_joint**". The joint "**base_joint**" is used to connect the link "**base_footprint**" with the link "**base_link**". The position is defined at the origin to prevent the wheels from being embedded into the ground after the definition.

<img class="common_img" src="../_static/media/chapter_5/section_1/image30.png">

**The robot's main body model (base_link)**

Defines the link "**base_link**" and then specifies it as a rectangular shape with the previously defined parameters.

The description of the link "**base_link**" (keyword "**visual**") is defined, including the following within the description: Position set at the origin (keyword "**origin**"), introduction of the related dynamics configuration file (keyword "**geometry**"), color defined as green (keyword "**material**").

Collision (keyword "**collision**"), collision position (keyword "**origin**"), and the collision area (keyword "**geometry**") are also defined.

<img class="common_img" src="../_static/media/chapter_5/section_1/image31.png">
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image34.jpeg">
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image35.png">
...
(2) slam_karto software package: [https://github.com/ros-perception/slam_karto](https://github.com/ros-perception/slam_karto)
...
① Click on <img src="../_static/media/chapter_5/section_1/image37.png">to open the virtual machine.
...
③Select the ubuntu_ros2_humble folder extracted locally (**Virtual Hosts/ubuntu_ros2_humble**), choose the Ubuntu 22.04 ROS2.ovf file, and click "**Open.**"
...
② Click-on <img src="../_static/media/chapter_5/section_1/image42.png">to open the ROS2 command-line terminal.
...
For detailed instructions on how to connect using the SSH remote connection tool MobaXterm, please refer to [1 Quick Start Guide\\JetAcker User Manual -\> 1.6 Establish Development Environment](1.getting_ready.md#development-environment-setup-and-configuration)

(2) Import Files into Virtual Machine

① Click-on <img src="../_static/media/chapter_5/section_1/image48.png"> to navigate to the home directory.
...
(1) Click-on <img src="../_static/media/chapter_5/section_1/image51.png"> to start the command-line terminal on the virtual machine.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image59.png">
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image61.png">

* **Configuring the Robot for Local Network Mode**

(1) Click on <img src="../_static/media/chapter_5/section_1/image62.png">to open the command line terminal. Then, enter the command to navigate to the wifi_manager directory.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image65.png">
...
(6) After restarting, click on <img src="../_static/media/chapter_5/section_1/image42.png">to open the ROS 2 command line terminal on the robot. Ensure that the `ROS_DOMAIN_ID` is set to 0, matching the virtual machine:

Robot:

<img class="common_img" src="../_static/media/chapter_5/section_1/image71.png">

Virtual machine: Click-on <img src="../_static/media/chapter_5/section_1/image51.png"> to access the virtual machine command-line terminal.
...
① Click-on <img src="../_static/media/chapter_5/section_1/image42.png"> to start the command-line terminal.
...
① Click-on <img src="../_static/media/chapter_5/section_1/image51.png"> to start the command-line terminal in the virtual machine system.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image75.png">

(3) Enable Keyboard Control for the Robot

① Click <img src="../_static/media/chapter_5/section_1/image42.png"> to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image77.png">
...
(1) Click-on <img src="../_static/media/chapter_5/section_1/image42.png"> to initiate the command-line terminal.
...
<img src="../_static/media/chapter_5/section_1/image79.png">
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image81.png">
...
① Click on <img src="../_static/media/chapter_5/section_1/image42.png">on the system desktop to open the command-line terminal.
...
① Click-on <img src="../_static/media/chapter_5/section_1/image51.png">to start the command-line terminal.
...
① Click-on <img src="../_static/media/chapter_5/section_1/image42.png">to launch a new command-line terminal.
...
Move the robot around the current space to build a more complete map.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/image86.png">
...
<img class="common_img" src="../_static/media/chapter_5/section_2/image3.png">The architecture diagram above can be further explained as one major component and three minor components, totaling four services.
...
<img src="../_static/media/chapter_5/section_2/image22.png" style="width:450px;" />
<img src="../_static/media/chapter_5/section_2/image23.png" style="width:450px;" />
</p>
...
For instructions on configuring the connection between the virtual machine and the robot, please refer to [5.1.4  slam_toolbox Mapping Algorithm](#anchor_5_1_4)

* **Robot Operations**

(1) Click-on <img src="../_static/media/chapter_5/section_2/image29.png"> to start the command line terminal.
...
① Click-on <img src="../_static/media/chapter_5/section_2/image32.png"> to start the virtual machine command-line terminal.
...
① Click <img src="../_static/media/chapter_5/section_2/image36.png"> to set the initial position of the robot. On the map interface, choose a position, click, and drag the mouse to select the robot's pose.

<img class="common_img" src="../_static/media/chapter_5/section_2/image37.png">

② After setting the initial position of the robot, the effect is as shown in the figure below:

<img class="common_img" src="../_static/media/chapter_5/section_2/image38.png">

③ Click <img src="../_static/media/chapter_5/section_2/image39.png"> and select a location on the map interface as the target point. Click the mouse once at that point. After selection, the robot will automatically generate a route and move to the target point.

<img src="../_static/media/chapter_5/section_2/image40.png">

④ After confirming the target point, the map will display two paths: the green line represents the direct path between the robot and the target point, and the dark blue line represents the planned path of the robot.
...
② Set each navigation point using <img src="../_static/media/chapter_5/section_2/image44.png"> as shown in the figure below:
...
* The effect after completing multi-point navigation is shown in the figure below:
...
[/home/ubuntu/ros2_ws/src/navigation/launch/navigation.launch.py](../_static/source_code/slam.zip)
...
For an introduction to the RTAB-VSLAM algorithm and its principles, refer to "**[5.1.5 RTAB-VSLAM 3D Vision Mapping & Navigation](#anchor_5_1_5)**" for study and reference.

* **Robot Operations**

(1) Start the robot, and access the robot system desktop using VNC.

(2) Click-on <img src="../_static/media/chapter_5/section_2/image29.png"> to open the command line terminal.
...
(1) Click-on <img class="common_img" src="../_static/media/chapter_5/section_2/image32.png"> to start the virtual-machine command-line terminal.
...
(3) Click <img src="../_static/media/chapter_5/section_2/image39.png">, and on the map interface, select a location as the target point by clicking the mouse once at that point. After the selection is made, the robot will automatically generate a route and move to the target point.
