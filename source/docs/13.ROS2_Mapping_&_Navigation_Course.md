...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image4.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image5.png" style="width:500px" />

The following tags will be used to write joint motion.

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image6.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image7.png" style="width:500px" />

**5. gazebo Tag**

This tag is used in conjunction with the Gazebo simulator. Within this tag, you can define simulation parameters and import Gazebo plugins, as well as specify Gazebo's physical properties, and more.

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image8.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image9.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image10.png" style="width:500px" />
...
1. To write the first link and use indentation to indicate that it is part of the currently set model. Set the name of the link using the following format: **`<link name="link name">`**. Finally, conclude with "**`</link>`**" to indicate the successful completion of the link definition.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image11.png" style="width:500px" />

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image12.png" style="width:500px" />
...
2. Write the link description and use indentation to indicate that it is part of the currently set link, and conclude with "`</visual>`".
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image13.png" style="width:500px" />

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image14.png" style="width:500px" />
...
3. The "**`<geometry>`**" tag is employed to define the shape of a link. Once the description is complete, include "**`</geometry>`**". Within the "**`<geometry>`**" tag, indentation is used to specify the detailed description of the link's shape. The following example demonstrates a link with a cylindrical shape: "**`<cylinder length="0.01" radius="0.2"/>`**". In this instance, "**`length="0.01"`**" signifies a length of 0.01 meters for the link, while "**`radius="0.2"`**" denotes a radius of 0.2 meters, resulting in a cylindrical shape.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image15.png" style="width:500px" />
...
4. The "**`<origin>`**" tag is utilized to specify the position of a link, with indentation used to indicate the detailed description of the link's position. The following example demonstrates the position of a link: "**`<origin rpy="0 0 0" xyz="0 0 0" />`**". In this example, "**`rpy`**" represents the roll, pitch, and yaw angles of the link, while "**`xyz`**" represents the coordinates of the link's position. This particular example indicates that the link is positioned at the origin of the coordinate system.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image16.png" style="width:500px" />
...
5. The "**`<material>`**" tag is used to define the visual appearance of a link, with indentation used to specify the detailed description of the link's color. To start describing the color, include "**`<material>`**", and end with "**`</material>`**" when the description is complete. The following example demonstrates setting a link color to yellow: "**`<color rgba="1 1 0 1" />`**". In this example, "**`rgba="1 1 0 1"`**" represents the color threshold for achieving a yellow color.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image17.png" style="width:500px" />
...
1. To write the first joint, use indentation to indicate that the joint belongs to the current model being set. Then, specify the name and type of the joint as follows: "**`<joint name="joint name" type="joint type">`**". Finally, include "**`</joint>`**" to indicate the completion of the joint definition.
   ...
   > [!NOTE]
   >
   > To learn about the type of the joint, please refer to "**[13.1.1 URDF Model->3. joint](#anchor_13_1_1_joint)**".

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image18.png" style="width:500px" />

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image19.png" style="width:500px" />
...
2. Write the description section for the connection between the link and the joint. Use indentation to indicate that it is part of the currently defined joint. The parent parameter and child parameter should be set using the following format: "**`<parent link="parent link"/>`**", and "**`<child link="child link" />`**". With the parent link serving as the pivot, the joint rotates the child link.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image20.png" style="width:500px" />
...
3. "**`<origin>`**" describes the position of the joint using indention. This example describes the position of the joint: "**`<origin xyz="0 0 0.1" />`**". xyz is the coordinate of the joint.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image21.png" style="width:500px" />
...
4. "**`<axis>`**" describes the position of the joint adopting indention. "**`<axis xyz="0 0 1" />`**" describes one posture of a joint. xyz specifies the pose of the joint.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image22.png" style="width:500px" />
...
5. "**`<limit>`**" imposes restrictions on the joint using indention. The below picture The "**`<limit>`**" tag is used to restrict the motion of a joint, with indentation indicating the specific description of the joint angle limitations. The following example describes a joint with a maximum force limit of 300 Newtons, an upper limit of 3.14 radians, and a lower limit of -3.14 radians. The settings are defined as follows: "**effort="joint force (N)", velocity="joint motion speed", lower="lower limit in radians", upper="upper limit in radians**".
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image23.png" style="width:500px" />
...
6. "**`<dynamics>`**" describes the dynamics of the joint using indention. "**`<dynamics damping="50" friction="1" />`**" describes dynamics parameters of a joint.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image24.png" style="width:500px" />

   The complete codes are as below.

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image25.png" style="width:700px" />

### 13.1.2 Explanation of ROS Robot URDF Model

**1. Preparation**

To grasp the URDF model, check out "**[13.1.1 URDF Model->Basic Syntax of URDF Model](#anchor_13_1_1_3)**" for the key syntax. This part quickly breaks down the robot model code and its components.

**2. Check Code of Robot Model**

1. Start the robot, and access the robot system desktop using NoMachine.

2. Click-on <img src="../_static/media/chapter_13/section_1/media/image26.png" style="width:50px" /> to open the ROS2 command-line terminal.

3. Execute the command and hit Enter key to navigate to the folder containing startup programs.
...
6. Locate the code below:
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image30.png" style="width:700px" />
...
**3. Brief Analysis of Robot's Main Body Model**
...
* **Main Robot Body Model Basic Parameter**
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image32.png" style="width:600px" />

* **Ackermann Wheel Simulation (taking the right front wheel as an example)**
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image33.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image34.png" style="width:700px" />

### 13.1.3 Principles of SLAM Map Building
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image35.jpeg" style="width:400px" alt="C:\Users\Administrator\Pictures\3.jpg3" />
...
### 13.1.4 slam_toolbox Mapping Algorithm
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image36.png" style="width:500px" alt="图片3" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image37.png" style="width:500px" alt="企业微信截图_17161958067120" />

* Import Virtual Machine Image

1. Click on <img src="../_static/media/chapter_13/section_1/media/image38.png" style="width:50px" /> to open the virtual machine.

2. Enter the virtual machine interface and click on "**Open Virtual Machine.**"

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image39.png" style="width:600px" />
...
3. Select the ubuntu_ros2_humble folder extracted locally (6 Virtual Hosts\ubuntu_ros2_humble), choose the Ubuntu 22.04 ROS2.ovf file, and click "**Open**."
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image40.png" style="width:600px" />

4. Enter your desired virtual machine name, select your preferred path, and click "Import."

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image41.png" style="width:500px" />

5. The import process is underway, displaying the import progress.

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image42.png" style="width:500px" />

6. After import completion, follow the prompts to complete the installation process.

**(2) Copy Robot Files to the Virtual Machine**

* Export Files from the Robot

1. Start the robot, and access the robot system desktop using NoMachine.

2. Click-on <img src="../_static/media/chapter_13/section_1/media/image43.png" style="width:50px" /> to open the ROS1 command-line terminal.
...
4. Click-on <img src="../_static/media/chapter_13/section_1/media/image26.png" style="width:50px" /> to start the ROS2 command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image49.png" style="width:500px" />
...
11. Click-on <img src="../_static/media/chapter_13/section_1/media/image51.png" style="width:50px" /> to open the file directory, then navigate to the home/docker/tmp directory:

    <img class="common_img" src="../_static/media/chapter_13/section_1/media/image52.png" style="width:500px" />

12. Use the shortcut 'Ctrl + H' to show the hidden .typerc file:

    <img class="common_img" src="../_static/media/chapter_13/section_1/media/image53.png" style="width:500px" />

13. Drag the two files from the directory to the computer desktop.

    <img class="common_img" src="../_static/media/chapter_13/section_1/media/image54.png" style="width:500px" />

* Import Files into the Virtual Machine

1. Click-on <img src="../_static/media/chapter_13/section_1/media/image55.png" style="width:50px" /> to navigate to the home directory.

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image56.png" style="width:500px" />

2. Drag and drop the .typerc and src.zip files from the computer desktop into the virtual machine:

   <img class="common_img" src="../_static/media/chapter_13/section_1/media/image57.png" style="width:500px" />

**(3) Create and Compile the Workspace**

1. Click-on <img src="../_static/media/chapter_13/section_1/media/image58.png" style="width:50px" /> to start the virtual machine command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image64.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image67.png" style="width:500px" />

10. After finishing writing, use the shortcut **Ctrl + S** or click the **Save** button in the upper right corner to save and exit.

 <img class="common_img" src="../_static/media/chapter_13/section_1/media/image68.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image69.png" style="width:700px" />

**(4) Set the Robot to LAN Mode**

1. Click-on <img src="../_static/media/chapter_13/section_1/media/image43.png" style="width:50px" /> to open the ROS1 command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image71.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image72.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image74.png" style="width:600px" />

Robot:

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image75.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image76.png" style="width:600px" />

6. After rebooting, click on <img src="../_static/media/chapter_13/section_1/media/image26.png" style="width:50px" /> to open the robot's ROS2 command line terminal. You will notice that the ROS_DOMAIN_ID is 0, which is the same as on the virtual machine.

Robot:

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image77.png" style="width:500px" />

Virtual Machine:

<img class="common_img" src="../_static/media/chapter_13/section_1/media/image78.png" style="width:500px" />

**(5) slam Mapping Instructions**
...
3. Click-on <img src="../_static/media/chapter_13/section_1/media/image26.png" style="width:50px" /> to open the ROS2 command-line terminal.
...
1. Click-on <img src="../_static/media/chapter_13/section_1/media/image58.png" style="width:50px" /> to open the command line terminal of the virtual machine system.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image81.png" style="width:600px" />

* Enable Keyboard Control

1. Click-on <img src="../_static/media/chapter_13/section_1/media/image26.png" style="width:50px" /> to open the ROS2 command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image83.png" style="width:500px" />
...
The robot itself comes with pre-calibrated IMU data loaded, enabling it to perform mapping and navigation functions effectively. However, calibrating the IMU can still enhance accuracy further. The calibration method and steps for the IMU can be found in the "**[10. Motion Control Course -\> 10.2 JetAcket Motion Control-\> 10.2.1 IMU & Linear Velocity Calibration](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/10.ROS2_Motion_Control_Course.html#imu-linear-velocity-calibration)**" section.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image85.png" style="width:500px" alt="图片1" />
   ...
   if slam_method == 'slam_toolbox':
       bringup_launch = GroupAction(
        actions=[
            ...
            base_launch,
            TimerAction(
                period=5.0,  # delay to wait for other nodes to start up properly
                actions=[slam_launch],
            ),
         ]
       )
...
<p id="anchor_13_1_5"></p> 

### 13.1.5 RTAB-VSLAM 3D Vision Mapping & Navigation
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image89.png" style="width:600px" alt="图片1" />
...
1. Click on <img src="../_static/media/chapter_13/section_1/media/image43.png" style="width:50px" /> on the system desktop to open the ROS1 command-line terminal.
...
1. Click-on <img src="../_static/media/chapter_13/section_1/media/image58.png" style="width:50px" /> to open the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image92.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_1/media/image93.png" style="width:500px" alt="图片2" />
...
### 13.2.1 ROS Robot Autonomous Navigation
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image4.png" style="width:400px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image5.png" style="width:600px" alt="IMG_256" />
...
### 13.2.2 AMCL Adaptive Monte Carlo Positioning
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image6.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image7.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image8.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image9.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image10.png" style="width:500px" alt="图片4" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image11.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image12.png" style="width:600px" alt="图片5" />
...
1. Initially, we set the distance from the starting point (start) to itself as 0, and all other points' distances are initialized to infinity.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_2/media/image13.png" style="width:500px" />
...
2. During the first iteration, we identify the point (let's call it Point 1) with the smallest distance value, mark it as processed, and update the distances of all adjacent points (previously unprocessed) connected to Point 1. For instance, if Point 1 is connected to Points 2, 3, and 4, we update their distances as follows: dis\[2\]=2, dis\[3\]=4, and dis\[4\]=7.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_2/media/image14.png" style="width:500px" />
...
3. In the subsequent iterations, we repeat the process: find the point with the smallest distance value (e.g., Point 2 in the second iteration), mark it as processed, and update the distances of its adjacent points (if necessary). For example, if Point 2 is connected to Points 3 and 5, we update their distances as dis\[3\]=3 and dis\[5\]=4.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_2/media/image15.png" style="width:500px" />
...
4. This procedure continues until all points have been processed. At each iteration, we select the unprocessed point with the smallest distance and update distances of its adjacent points accordingly.
   ...
   <img class="common_img" src="../_static/media/chapter_13/section_2/media/image16.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image17.png" style="width:400px" />

2.  Calculate the distance of horizontal and vertical movement; diagonal calculation is applicable (diagonal distance).

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image18.png" style="width:400px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image19.png" style="width:500px" alt="1693578769761" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image20.png" style="width:400px" alt="1693578966606" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image21.png" style="width:400px" />

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image22.png" style="width:400px" />

**2. Formula**

The figure below illustrates the optimization objective function in the TEB algorithm:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image23.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image24.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image25.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image26.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image27.png" style="width:500px" />
...
### 13.2.4 Point-to-Point and Multi-Point Navigation and Obstacle Avoidance

Before initiating navigation, it's essential to enable the robot to map. You can find detailed guidance on this process in '**[13.1.4 lam_toolbox Mapping Algorithm/ 2. Mapping Operation Steps](#anchor_13_1_4_2)**’.

* **Robot Operations**

1. Click-on <img src="../_static/media/chapter_13/section_2/media/image28.png" style="width:50px" /> to open the ROS1 command line terminal.
...
3. Click <img src="../_static/media/chapter_13/section_2/media/image30.png" style="width:50px" /> on the system desktop to open the ROS2 command line terminal.
...
1. Click-on <img src="../_static/media/chapter_13/section_2/media/image32.png" style="width:50px" /> to open the command-line terminal on the virtual machine.
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image34.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image35.png" style="width:500px" />

1. Click <img src="../_static/media/chapter_13/section_2/media/image36.png" style="width:200px" /> to set the initial position of the robot. On the map interface, choose a position, click, and drag the mouse to select the robot's pose.

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image37.png" style="width:500px" />

2. After setting the initial position of the robot, the effect is as shown in the figure below:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image38.png" style="width:500px" />

3. Click <img src="../_static/media/chapter_13/section_2/media/image39.png" style="width:200px" /> and select a location on the map interface as the target point. Click the mouse once at that point. After selection, the robot will automatically generate a route and move to the target point.

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image40.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image41.png" style="width:500px" />

5. When encountering obstacles, the robot will bypass them and continuously adjust its posture and travel route.

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image42.png" style="width:500px" />

* **Multi-Point Navigation**

1. Click the "**waypoint**" button to start multi-point navigation:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image43.png" style="width:500px" />

2. Set each navigation point using <img src="../_static/media/chapter_13/section_2/media/image44.png" style="width:150px" /> as shown in the figure below:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image45.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image46.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image47.png" style="width:500px" />

5. The effect after completing multi-point navigation is shown in the figure below:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image48.png" style="width:500px" />

* **Launch Description**

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image49.png" style="width:600px" alt="图片1" />
...
base_launch = IncludeLaunchDescription(
    ...
    bringup_launch = GroupAction(
     actions=[
         ...
         base_launch,
         TimerAction(
             period=10.0, # delay to wait for other nodes to start up properly
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image53.png" style="width:700px" />

config: Contains configuration parameters related to navigation, as shown below:

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image54.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image55.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image56.png" style="width:700px" />

Package.xml: Configuration information file for the current package.

### 13.2.5 RTAB-VSLAM 3D Navigation

* **Algorithm Introduction & Principle**

For an introduction to the RTAB-VSLAM algorithm and its principles, refer to "[**13.1.5 RTAB-VSLAM 3D Vision Mapping & Navigation**](#anchor_13_1_5)" for study and reference.

* **Robot Operations**

1. Start the robot, and access the robot system desktop using NoMachine.

2. Click-on <img src="../_static/media/chapter_13/section_2/media/image28.png" style="width:50px" /> to open the ROS1 command line terminal.
...
4. Click <img src="../_static/media/chapter_13/section_2/media/image30.png" style="width:50px" /> on the system desktop to open the ROS2 command line terminal.
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image59.png" style="width:500px" />

3. Click <img src="../_static/media/chapter_13/section_2/media/image39.png" style="width:200px" />, and on the map interface, select a location as the target point by clicking the mouse once at that point. After the selection is made, the robot will automatically generate a route and move to the target point.

<img class="common_img" src="../_static/media/chapter_13/section_2/media/image60.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image61.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_13/section_2/media/image49.png" style="width:700px" alt="图片1" />
