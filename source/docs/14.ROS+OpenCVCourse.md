...
> [!NOTE]
>
> The adjustment method of color threshold refers to "**[14.1.3 Adjust Color Adjustment](#anchor_14_1_3)**".
...
Firstly, obtain the RGB image from the camera. Scale and apply Gaussian blur to the image. Convert the image from RGB to Lab. (For detailed explanations regarding the Lab color space, you can refer to "**[7. ROS+OpenCV Lesson](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/7.ROS%2BOpenCV_Lesson.html)**".)
