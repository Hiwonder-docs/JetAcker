# 5. Mapping Navigation Lesson

<p id="anchor_5_1"></p>

## 5.1 Mapping

### 5.1.1 SLAM Mapping Principle
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image4.jpeg" style="width:500px"  />
...
<launch>
    ...
    <include file="$(find hiwonder_slam)/launch/include/hiwonder_robot.launch">
        ...
        <arg if="$(eval slam_methods == rtabmap)" name="horizontal" value="true"/>
        <arg if="$(eval slam_methods == rtabmap)" name="enable_depth" value="true"/>
    </include>
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image6.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image7.png" style="width:400px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image8.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image9.png" style="width:400px" />

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image10.png" style="width:400px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image11.png" style="width:500px" />
...
4)  The '**rviz**' folder is designated for storing simulation maps and robot model files. Save the simulation models needed for different mapping algorithms in this folder. This facilitates their later use when launching RVIZ to inspect mapping results
    ...
    <img class="common_img" src="../_static/media/chapter_5/section_1/media/image12.png" style="width:500px" />

5)  The '**src**' folder serves as the directory for calling algorithm source files.

    <img class="common_img" src="../_static/media/chapter_5/section_1/media/image13.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image14.png" style="width:500px" />
...
**(2) Slam_Gmapping Software Package:** https://github.com/ros-perception/slam_gmapping

**(3) OpenSlam_Gmapping Open Source Algorithm:** https://github.com/ros-perception/openslam_gmapping
...
2. Double click <img src="../_static/media/chapter_5/section_1/media/image15.png" style="width:50px" /> to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image17.png" style="width:500px" />

The appearance of the following message indicates a successful startup.

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image18.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image19.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image20.png" style="width:500px" />

**2. Start Mapping**

Take keyboard control as example. If you want to control the robot using wireless handle, please refer to the tutorial saved in '**[1. Getting Ready/1.7 Wireless Handle Control](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html#wireless-handle-control)**'.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image22.png" style="width:500px" />

1)  Control the robot to move around to map the whole environment by pressing the corresponding keys.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image23.png" style="width:500px" />
...
The calibrated IMU (Inertial Measurement Unit) data has been successfully integrated into the robot's system, enabling both mapping and navigation. However, to achieve even greater accuracy, it's advisable to calibrate the IMU. Detailed instructions on how to perform IMU calibration are available in **"[2. Chassis Motion Control Lesson\ 2.2.1 IMU and Linear Velocity Calibration](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/2.ROS1-Chassis_Motion_Control_Lesson.html#imu-linear-velocity-calibration)"**.
...
To access the detailed tutorials, please refer to this link：http://wiki.ros.org/gmapping2.4 Launch File Analysis
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image27.png" style="width:700px"  />

Reviewing the document structure, the focus is on selecting mapping methods, initiating mapping functionalities, configuring relevant topics, and adjusting mapping method parameters. For detailed syntax guidelines, please refer to the **[8. ROS2 Basics Lesson](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/8.ROS2_Basic_Course.html)**.
...
After choosing the mapping method (**slam_methods**), the subsequent step involves initiating the mapping functionality and configuring relevant topic names through the use of slam_base.launch.

In the provided diagram, \<sim\> signifies whether simulation is utilized. In this context, it refers to the simulation parameter (sim), which defaults to false, indicating that the node simulation is inactive. \<slam_methods\> denotes the selected mapping method, set as "**gmapping**" for this mapping session. \<robot_name\> specifies the node name of the robot.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image33.png" style="width:300px" />

<p style="text-align:center">Parameter configuration file segment 1</p>
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image34.png" style="width:200px" />
...
> [!NOTE]
>
> **It is recommended to maintain the default settings for the above parameters. Modifying them independently is not advised, as it may impact the effectiveness of the game!!!**

### 5.1.3 Hector Mapping Algorithm

* **Hector Description**

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image35.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image36.png" style="width:700px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image37.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image40.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image42.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image45.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image48.png" style="width:700px"  />
...
efore mapping, it is necessary to choose a mapping method, as shown in the diagram above:
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image54.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image61.png" style="width:700px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image65.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image66.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image69.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image71.png" style="width:700px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image79.png" style="width:700px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image82.png" style="width:500px" />
...
The calibrated IMU (Inertial Measurement Unit) data has been successfully integrated into the robot's system, enabling both mapping and navigation. However, to achieve even greater accuracy, it's advisable to calibrate the IMU. Detailed instructions on how to perform IMU calibration are available in "**[ 2. Chassis Motion Control Lesson](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/2.ROS1-Chassis_Motion_Control_Lesson.html)".**
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image83.png" style="width:500px"  />

Reviewing the document structure, the focus is on selecting mapping methods, initiating mapping functionalities, configuring relevant topics, and adjusting mapping method parameters. For detailed syntax guidelines, please refer to the '**[ROS Basics Lesson](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/8.ROS2_Basic_Course.html)**'.
...
Given the game's focus on independent mapping, the Gmapping mapping algorithm is integrated with the navigation algorithm throughout the mapping process. For an in-depth analysis of Gmapping content, please consult the '**[5.1.2 Gmapping Mapping Algorithm Launch File Analysis](#anchor_5_1_2)**'
...
- **'global_frame' \[global coordinate system\], set to 'map_frame' \[map coordinate system\].**

- 'clicked_frame' \[target point click coordinates\], set to 'clicked_point' ["topic_prefix)/clicked_point"\], where 'topic_prefix)/clicked_point' corresponds to the default value of 'clicked_point' in the launch document

- 'cmd_vel_topic' \[Robot speed topic\], set to 'cmd_vel_topic' \['topic_prefix)/hiwonder_controller/cmd_vel'\], corresponding to the default value of 'cmd_vel_topic' in the launch document.
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image89.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image90.png" style="width:600px"  />
...
**7. Initiate Mapping Function and Related Topic Configuration**
...
1)  gmapping.launch: For a detailed explanation of the primary content, please consult the "**[5.1.2 Analysis of Gmapping Mapping Algorithm Launch File](#anchor_5_1_2)**."

2)  The launch folder in the function package hiwonder_slam within this game includes a folder named include. For specifics, please refer to "**[5.1.8 RRT Exploration Mapping->2.Launch File Analysis->5. Mapping Method Parameter Configuration](#anchor_5_1_8_4_5)**."
...
**8. Mapping Method Parameter Configuration**
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image94.png" style="width:400px"  />
...
> [!NOTE]
>
> **Once you activate the mapping service, the robot will autonomously plan a path and commence mapping. Therefore, ensure to position it on the ground before powering it on.**
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image97.png" style="width:500px"  />

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image98.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image99.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image101.png" style="width:600px"  />
...
3)  The hiwonder_slam function package for this game contains a folder named include. Delve into the details by consulting 5. Mapping Method Parameter Configuration.

For specific contents within the slam_base.launch file, consult "**slam_base.launch Program Analysis**."
    
<p id="anchor_5_1_8_4_5"></p>
...
3. `<clicked_point>` defines five points in the area. The first four points represent the corners of the square areas to be explored, while the last point designates the starting point of the tree, indicating where the robot commences its operation.

4. `<wait_finish_time>` denotes the waiting time for messages after reaching the target. Although this parameter is flexible, it is advisable to set it greater than 3 seconds to ensure the complete establishment of the map.

> [!NOTE]
>
> **It is recommended to maintain the default settings for the above parameters. Modifying them independently is not advised, as it may impact the effectiveness of the game!!!**

### 5.1.9 ORBSLAM2 and ORBSLAM3 Mapping
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image108.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image109.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image110.png" style="width:800px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image113.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image115.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image116.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image118.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image119.png" style="width:500px" />

8)  Utilize the shortcut '**Ctrl+C**' to terminate each program running on different terminals.

### 5.1.10 RTAB-VSLAM 3D Mapping & Navigation
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image120.png" style="width:600px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image123.png" style="width:500px" />
...
7)  Open a new command-line terminal, and execute this command '**roslaunch hiwonder_peripherals teleop_key_control.launch robot_name:=/**' to enable the keyboard control service.

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image42.png" style="width:600px" />

8)  Control the robot to move around to map the whole environment by pressing the corresponding keys.
...
9)  After mapping, utilize the shortcut '**Ctrl+C**' to terminate each program running on different terminals.

> [!NOTE]
>
> **3D mapping does not require manual saving of the map. When you use "Ctrl+C" to terminate the mapping command, the map will be automatically saved.**
...
The installation packages for the mobile apps 'Make A Map' and 'Map Nav' are located in the directory '**[5.2.6 App Navigation](#anchor_5_2_6)**'. Users can import these packages into their mobile phones for installation.

> [!NOTE]
>
> * **Only installation packages for Android systems are provided for the app.**
>
> * **If you open the mapping, click on** <img src="../_static/media/chapter_5/section_1/media/image124.png" style="width:50px" /> **desktop icon to verify the Lidar model (The default Lidar model is "G4"). If the Lidar has been changed, update the Lidar model to the corresponding one and save the changes for them to take effect.**
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image126.png" style="width:400px" />

2)  Open "**Make A Map**" app, and select "**http://192.168.149.1:11311/**" in "**Master URI**" field, then click "**CONNECT**".

<img class="common_img" src="../_static/media/chapter_5/section_1/media/image127.png" style="width:400px" />
...
>
> * **If there is no map on the yellow frame, you can click-on** <img src="../_static/media/chapter_5/section_1/media/image124.png" style="width:50px" /> **to check whether the Lidar model is correct. The default Lidar model set in the system image is G4. If the Lidar you are using other Lidar model, please change it to corresponding model.**
...
<img class="common_img" src="../_static/media/chapter_5/section_1/media/image128.png" style="width:500px" />
...
1. Open a new command-line terminal, and execute the command "**roscd hiwonder_slam/maps**" and press Enter to save the map to the corresponding folder.

```bash
roscd hiwonder_slam/maps
```

2. Input command "**rosrun map_server map_saver map:=/map -f map_01**" and press Enter to save the map.
...
3)  Press the shortcut "**Ctrl+C**" to close the current program window.
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image7.png" style="width:500px" />
...
> [!NOTE]
>
> The navigation function package has been pre-installed on the car prior to leaving the factory.

### 5.2.2 AMCL Adaptive Monte Carlo Positioning

1. **AMCL Wiki：**http://wiki.ros.org/amcl

2. **AMCL package link：**https://github.com/ros-planning/navigation/tree/melodic-devel/amcl
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image12.png" style="width:400px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image18.png" style="width:700px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image20.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image22.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image23.png" style="width:400px" />

2.  Calculate the distance of horizontal and vertical movement; diagonal calculation is applicable (diagonal distance).

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image24.png" style="width:400px" />
...
2. **Motion Simulation:** The DWA algorithm conducts a motion simulation for each speed-angular velocity pair, determining the trajectory of the robot based on these combinations in its current 
state.
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image26.png" style="width:400px"  />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image30.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image31.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image32.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image33.png" style="width:500px" />
...
Before initiating navigation, it's essential to enable the robot to map. You can find detailed guidance on this process in '**[5.1 Mapping](#anchor_5_1)**'.
...
2. Double-click <img src="../_static/media/chapter_5/section_2/media/image34.png" style="width:50px" /> to open the command-line terminal.
...
Click <img src="../_static/media/chapter_5/section_2/media/image40.png" style="width:100px" /> to access the map interface. Next, select a point on the map as the target destination by clicking once with the mouse. Upon completion of the selection, the robot will autonomously generate a route and navigate towards the target.

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image41.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image42.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image43.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image44.png" style="width:500px" />
...
**Rviz:** Contains parameter loading for the rviz visualization tool, comprising robot configuration files and navigation configuration files for various navigation algorithms, as shown in the figure below.

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image46.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image47.png" style="width:500px" />
...
> [!NOTE]
>
> **Input commands are case-sensitive, and keywords can be completed using the 'Tab' key for convenience.**
...
8. Click on <img src="../_static/media/chapter_5/section_2/media/image51.png" style="width:150px" />, then randomly select a point by clicking the left mouse button to set it as the target point. Repeat this process to set the remaining target points in the same manner.

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image52.png" style="width:500px" />

> [!NOTE]
>
> **Before setting a target point, ensure to click "Publish Point" once.**
...
> [!NOTE]
>
> **To interrupt navigation, utilize the "2D Nav_Goal" tool to designate the current position of the robot as the target point. In case the robot is displaced from its original position due to external factors such as being lifted off the ground or subjected to external forces, both the robot's initial position and target point will require resetting.**

**2. Feature Pack Description**

Please refer to the section '**[5.2.4 Point-to-Point and Multi-Point Navigation and Obstacle Avoidance->Point-to-Point Navigation ->2. Feature Pack Description]()**'.

### 5.2.5 RTAB-VSLAM 3D Mapping & Navigation

* **Algorithm Introduction & Working Principle**

For an introduction to and the principles behind the RTAB-VSLAM algorithm, please consult "**[5.1.1 SLAM Mapping Principle](#anchor_5_1)**
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image60.png" style="width:500px" />

2D Nav Goal and Publish Point。In the menu bar, there are two tools available: "**2D Nav Goal**" and "**Publish Point.**"

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image61.png" style="width:400px" />
...
8)  To set a target point using the "**2D Nav Goal**" tool, follow these steps:
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image62.png" style="width:500px" />

9)  Once the target point is set, the map will display two paths:
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image63.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image64.png" style="width:500px" />
...
### 5.2.6 App Navigation

This file deals with how to use "**Map Nav**" app to control JetAcker to navigate through the environment.

* **APP Installation**

The app installation packs can be found in '**[2. Software/ APP Mapping and Navigation](https://drive.google.com/drive/folders/1W4jJDB8q_-7sptIK46q4IkB7bTHps1qf?usp=sharing)**'. You can transfer them to your phone to install.

> [!NOTE]
>
> * The app is only applicable to Android system.
>
> * If there is no map on the yellow frame, you can click-on <img src="../_static/media/chapter_5/section_2/media/image66.png" style="width:50px" /> to check whether the Lidar model is correct. The default Lidar model set in the system image is G4. If the Lidar you are using other Lidar model, please change it to corresponding model.
...
2. Click-on <img src="../_static/media/chapter_5/section_2/media/image67.png" style="width:50px" /> to open the command-line terminal.

Execute the command '**sudo systemctl stop start_app_node.service**' and hit Enter to terminate the app auto-start service.

```bash
sudo systemctl stop start_app_node.service
```

3. Open a new command, and execute this command "**roslaunch hiwonder_navigation navigation.launch map:=map_01 app:=true**" to enable navigation service.

```bash
roslaunch hiwonder_navigation navigation.launch map:=map_01 app:=true
```

4)  If you want to stop running the current program, press "**Ctrl+C**" on the terminal.
...
<img class="common_img" src="../_static/media/chapter_5/section_2/media/image70.png" style="width:400px" />

2)  Open "**Map Nav**" app, and input "**http://192.168.149.1:11311/**" in "**Master URI**" bar, then click "**CONNECT**".

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image71.png" style="width:400px" />

**3. Introduction to Map Nav**

> [!NOTE]
>
> **The icon enclosed in blue frame in below figure serves no practical purpose. Map will be loaded automatically.**

The interface is divided into four areas. The live camera feed is displayed in the yellow section, and the map is display in the green section. In red area, you can control the robot to move. Combine the option of "**Set Pose**" and "**Set Goal**" and green section to set the initial position and destination of the robot.

<img class="common_img" src="../_static/media/chapter_5/section_2/media/image72.png" style="width:500px" />

1)  Select "**Set Pose**", then press one point on the map to set it as the initial position of robot.

2)  Drag arrow in red section to control JetAcker to move so as to calibrate the position.
...
During the movement of robot, the robot's movement speed as a percentage will be displayed in the red box.