...
Take keyboard control as example. If you want to control the robot using wireless handle, please refer to the tutorial saved in ‘**[1. Getting Ready/1.7 Wireless Handle Control]()**’.
...
Reviewing the document structure, the focus is on selecting mapping methods, initiating mapping functionalities, configuring relevant topics, and adjusting mapping method parameters. For detailed syntax guidelines, please refer to the **[8. ROS2 Basics Lesson]()**.
...
Given the game's focus on independent mapping, the Gmapping mapping algorithm is integrated with the navigation algorithm throughout the mapping process. For an in-depth analysis of Gmapping content, please consult the '**[5.1.2 Gmapping Mapping Algorithm Launch File Analysis]()**'
...
1)  gmapping.launch: For a detailed explanation of the primary content, please consult the "**[5.1.2 Analysis of Gmapping Mapping Algorithm Launch File]()**."

2)  The launch folder in the function package hiwonder_slam within this game includes a folder named include. For specifics, please refer to "**[5.1.8 RRT Exploration Mapping->2.Launch File Analysis->5. Mapping Method Parameter Configuration]()**."
...
The installation packages for the mobile apps 'Make A Map' and 'Map Nav' are located in the directory '**[5.Mapping Navigation Lesson -> 5.2.6 App Installation Package]()**'. Users can import these packages into their mobile phones for installation.
...
Before initiating navigation, it's essential to enable the robot to map. You can find detailed guidance on this process in ‘**[5.Mapping Navigation Lesson/ Mapping]()**’.
...
For an introduction to and the principles behind the RTAB-VSLAM algorithm, please consult "**[5.1.1 SLAM Mapping Principle]()**
...
The app installation packs can be found in ‘**[2. Software/ 7. APP Mapping and Navigation]()**’. You can transfer them to your phone to install.
