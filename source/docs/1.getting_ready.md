...
<table class="docutils-nobg" border="1" style="text-align:center;">
  ...
  <tbody>
    <tr>
      ...
      <td>JetAcker</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image1.png" style="width:300px;" /></td>
    </tr>
    <tr>
      <td>2</td>
      <td>12.6V Lipo battery charger</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image2.png" style="width:200px;"/></td>
    </tr>
    <tr>
      <td>3</td>
      <td>Card Reader</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image3.png"  style="width:150px;"/></td>
    </tr>
    <tr>
      <td>4</td>
      <td>Wireless handle</td>
      <td>3</td>
      <td><img src="../_static/media/chapter_1/image4.png" style="width:150px;"/></td>
    </tr>
    <tr>
      <td>5</td>
      <td>Screwdriver + Screw bag</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image5.png" style="width:50px;"/></td>
    </tr>
    <tr>
      <td>6</td>
      <td>User Manual</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image6.png" style="width:200px;"/></td>
    </tr>
  </tbody>
</table>
...
<table class="docutils-nobg" border="1" style="text-align:center;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image311.png" style="width:200px;"/></td>
    </tr>
    <tr>
      <td>8</td>
      <td>Tags(6.5*6.5cm)</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image312.png" style="width:200px;"/></td>
    </tr>
    <tr>
      <td>9</td>
      <td>Blocks(3*3cm)</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image313.png" style="width:200px;"/></td>
    </tr>
  </tbody>
</table>
...
<table class="docutils-nobg" border="1" style="text-align:center;">
  ...
  <tbody>
    ...
    <tr>
      <td>10</td>
      <td>7-inch LCD screen</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image314.png" style="width:200px;"/></td>
    </tr>
    <tr>
      <td>11</td>
      <td>HDMI cable</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image315.png" style="width:200px;"/></td>
    </tr>
    <tr>
      <td>12</td>
      <td>Data cable</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image316.png" style="width:200px;"/></td>
    </tr>
  </tbody>
</table>
...
<table class="docutils-nobg" border="1" style="text-align:center;">
  ...
  <tbody>
    ...
    <tr>
      <td>13</td>
      <td>Circular 6-Microphone Array</td>
      <td>1</td>
      <td><img src="../_static/media/chapter_1/image317.png" style="width:200px;"/></td>
    </tr>
  </tbody>
</table>
...
<img src="../_static/media/chapter_1/image68.png" class="common_img" style="width:450px"  /> <img src="../_static/media/chapter_1/image69.png" class="common_img" style="width:450px" />
...
Reminder: if you purchased the robot kit without Jetson or Raspberry Pi board, please first go through the content from [1.6 Development Environment Setup]() and Configuration to [1.6.7 Robot Version Configuration Tool Instructions]().
...
(1) **Android user:** the installation package can be found in [APP Installation Package]() and please transfer it to your phone for downloading.
...
(9) You can search for its IP address through the remote connection tool and establish a connection. For detailed instructions, please refer to [**"1.6  Development Environment Setup"**]().
...
(1) Enter the same directory as this document to open the installation package [nomachine_8.4.2_10_x64]().
...
(1) Enter the same directory as this document to open the installation package [VNC-Viewer-6.17.731-Windows]() . In the pop-up dialog box, select **'English'** as the installation language and click the **'OK'** button.
...
(1) Locate the [MobaXterm]() installation package .
...
* The system image has made special configurations for WI-FI, so the WI-FI option cannot be directly selected from the menu bar, as shown in the image below. This does not affect the normal operation of the robot. Users can refer to the  [1.6.4 Method to Restore WI-FI Option in Menu Bar]()     for the necessary settings.
...
(12) Enter the obtained IP address into NoMachine to establish a remote connection. For detailed instructions, please refer to the tutorial [**"7.2.1. AP Direct Connection Mode."**]()
...
(5) After the driver is installed, you need to refer to either[1.6.2 AP Direct Connection Mode Operations]() to log in the system. You only need to modify the address bar to **"192.168.55.1"**.
...
(2) Once connected to the remote desktop, double-click on<img src="../_static/media/chapter_1/image200.png" class="common_img" /> or<img src="../_static/media/chapter_1/image201.png" class="common_img" /> for robot system configuration.
...
For the remote system desktop connection, please refer to [**"4.2 Remote Device Connection"**]().
...
For the remote system desktop connection, please refer to [**"Remote Device Connection"**]().
...
* If you want to learn about how to save multiple maps, please delve into the content in [**"5. Mapping and Navigation Courses"**]() .
...
<img src="../_static/media/chapter_1/image68.png" style="width:450px" class="common_img" /> <img src="../_static/media/chapter_1/image69.png" style="width:450px" class="common_img" />
...
For more detailed STM32 code instructions, you can go through the source code, which contains very detailed comments. You can also refer to the [**"1 Tutorial\2 Development Basic Course\4 STM32 Control Board Course"**]() for additional information.
...
<img src="../_static/media/chapter_1/image292.png" class="common_img" /><img src="../_static/media/chapter_1/image293.png" class="common_img" />
