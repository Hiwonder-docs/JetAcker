...
Firstly, obtain the RGB image from the camera. Scale and apply Gaussian blur to the image. Convert the image from RGB to Lab. (For detailed explanations regarding the Lab color space, you can refer to "**[7.7 Color Threshold Adjustment](#anchor_7_7)**".)
...
> [!NOTE]
>
> This section is only for program analysis only. For hands-on experience, please refer to "**[1. JetAcker User Manual](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/1.Getting_Ready.html)**".
...
| <img src="../_static/media/chapter_7/section_1/media/image95.png" style="width:200px" /> | Choose color to adjust the threshold.                        |
| <img src="../_static/media/chapter_7/section_1/media/image96.png" style="width:200px" /> | Delete the currently selected color.                         |
| <img src="../_static/media/chapter_7/section_1/media/image97.png" style="width:200px" /> | Add recognizable color.                                      |
| <img src="../_static/media/chapter_7/section_1/media/image98.png" style="width:200px" /> | Save the adjustment result of the color threshold.           |
| <img src="../_static/media/chapter_7/section_1/media/image99.png" style="width:200px" /> | Click on this button to swap Depth camera/monocular camera.  |
| <img src="../_static/media/chapter_7/section_1/media/image100.png" style="width:200px" /> | Close LAB TOOL.                                              |
...
> [!NOTE]
>
> The adjustment method of color threshold refers to "**[7.7 Color Threshold Adjustment](#anchor_7_7)**".
