...
<img class="common_img" src="../_static/media/chapter_8/section_1/image100.png" style="width:400px;"/>
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image101.png" style="width:600px;"/>
...
<img class="common_img" src="../_static/media/chapter_8/section_1/image103.1.png" style="width:600px;"/>
...
(2) Confirm that the "**APPID**" in the configuration file has been modified and the "**Common.jet**" file has been replaced. You can refer to the document [8.3.1 Apply for Offline Voice Resources and ID](#anchor_8.3_1) for the application of APPID and file replacement process.
...
(8) Restart the game according to the section [8.4.3 Operation Steps](#anchor_8.4_3).
...
(3) If the above preparations have not been completed, please refer to the [8.3.1 Apply for Offline Voice Resources and ID](#anchor_8.3_1) directory for instructions on how to apply for an APPID and replace the file
...
(8)Restart the game according to the instructions provided in "**[8.7.3 Operation Steps](#anchor_8.7_3)**".