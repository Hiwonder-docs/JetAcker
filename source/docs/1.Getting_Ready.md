...
| :--: | :------------------------: | :------: | :----------------------------------------------------------: |
|  1   |          JetAcker          |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image1.png" style="width:500px" /> |
|  2   | 12.6V Lipo battery charger |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image2.png" style="width:300px"/> |
|  3   |        Card Reader         |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image3.png"  style="width:70px"/> |
|  4   |      Wireless handle       |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image4.png" style="width:200px"/> |
|  5   |  Screwdriver + Screw bag   |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image5.png" style="width:200px"/> |
|  6   |        User Manual         |    1     | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image6.png" style="width:300px"/> |
...
| ---- | -------------------------- | -------- | :----------------------------------------------------------: |
| 1    | JetAcker                   | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image1.png" style="width:500px" /> |
| 2    | 12.6V Lipo battery charger | 1        | <img class="common_img" src="../_static/media/chapter_1//section_1/media/image2.png" style="width:200px"/> |
| 3    | Card Reader                | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image3.png"  style="width:70px"/> |
| 4    | Wireless handle            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image4.png" style="width:200px"/> |
| 5    | Screwdriver + Screw bag    | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image5.png" style="width:300px"/> |
| 6    | User Manual                | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image6.png" style="width:250px"/> |
| 7    | 3D depth camera            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image311.png" style="width:200px"/> |
| 8    | Tags(6.5*6.5cm)            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image312.png" style="width:300px"/> |
| 9    | Blocks(3*3cm)              | 3        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image313.png" style="width:300px"/> |
...
| 3    | Card Reader                | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image3.png"  style="width:70px"/> |
| 4    | Wireless handle            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image4.png" style="width:200px"/> |
| 5    | Screwdriver + Screw bag    | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image5.png" style="width:250px"/> |
| 6    | User Manual                | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image6.png" style="width:300px"/> |
| 7    | 3D depth camera            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image311.png" style="width:250px"/> |
| 8    | Tags(6.5*6.5cm)            | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image312.png" style="width:300px"/> |
| 9    | Blocks(3*3cm)              | 3        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image313.png" style="width:300px"/> |
| 10   | 7-inch LCD screen          | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image314.png" style="width:200px"/> |
| 11   | HDMI cable                 | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image315.png" style="width:200px"/> |
| 12   | Data cable                 | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image316.png" style="width:200px"/> |
...
| 8    | Tags(6.5*6.5cm)             | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image312.png" style="width:300px"/> |
| 9    | Blocks(3*3cm)               | 3        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image313.png" style="width:300px"/> |
| 10   | 7-inch LCD screen           | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image314.png" style="width:300px"/> |
| 11   | HDMI cable                  | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image315.png" style="width:200px"/> |
| 12   | Data cable                  | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image316.png" style="width:200px"/> |
| 13   | Circular 6-Microphone Array | 1        | <img class="common_img" src="../_static/media/chapter_1/section_1/media/image317.png" style="width:200px"/> |
...
For exploring its functionality and view the program, you need to connect to the robot’s system through the remote connection tool, please refer to the subsequent content under “**[1.6 Development Environment Setup]()**”.
...
Reminder: if you purchased the robot kit without Jetson or Raspberry Pi board, please first go through the content from “**[1.6 Development Environment Setup]()” to “[1.6.7 Robot Version Configuration Tool Instructions]()**”.
...
1)  **Android user:** the installation package can be found in **“[Appendix/ APP Installation Package]()”** and please transfer it to your phone for downloading.
...
For detailed usage instructions for each mode, please refer to the content in “**[1.5.2 APP Function Overview]()**”.
...
9)  You can search for its IP address through the remote connection tool and establish a connection. For detailed instructions, please refer to “**[7. Development Environment Setup]()**”.
...
1)  Enter the same directory as this document to open the installation package “**nomachine_8.4.2_10_x64**” in the folder “[**Appendix->Remote Desktop Tool**]()”.
...
1)  Enter the same directory as this document to open the installation package “**VNC-Viewer-6.17.731-Windows**” in the folder “[**VNC-Viewer-6.17.731-Windows**]()”. In the pop-up dialog box, select '**English**' as the installation language and click the '**OK**' button.
...
8)  Once VNC is connected, simply click-on <img src="../_static/media/chapter_1/section_1/media/image97.png" style="width:150px"  /> to access it.
...
1)  Locate the “**MobaXterm**” installation package in this folder ‘**[Appendix]()**’.
...
>
> * The system image has made special configurations for WI-FI, so the WI-FI option cannot be directly selected from the menu bar, as shown in the image below. This does not affect the normal operation of the robot. Users can refer to the "**[1.6.4 Method to Restore Wi-Fi Option in the Menu Bar]()**" for the necessary settings.
>
...
5)  After the driver is installed, you need to refer to either “**[1.6.2 AP Direction Connection Mode]()**” or “**[1.6.3 LAN Mode Connection]()**” to log in the system. You only need to modify the address bar to “**192.168.55.1**”.
...
The following demonstrations are provided for four types of cotrol boards: Jetson Nano, Jetson Orin Nano, Jetson Orin NX, and Raspberry Pi 5. For an introduction to the differences in terminals, please refer to the "**[1.6.6 System Command-line Terminal Introduction]()**“.
...
**Software**: ATK-XISP (available in "**[Appendix]()**"):
...
> [!NOTE]
>
> The STM32 main control board comes with pre-installed firmware. You can flash the RRC_20240702.hex file located in the "**[Source Code Materials\STM32]()**" folder.
...
> [!NOTE]
>
> * Before flashing the image, you can use the SSD initialization tool (the compressed file can be found in [**"Image Flashing Tools/ SSD Initialization Tool"**]()) to delete any unnecessary partitions on the disk, then proceed with the flashing.
...
2. Locate the compressed file in "**[Image Flashing Tools\1. SSD Initialization Tool]().**" After extracting it, use the **DiskGenius.exe** tool to format the SD card or solid-state drive. Be cautious to select the correct drive letter to avoid formatting your computer's drives by mistake.
