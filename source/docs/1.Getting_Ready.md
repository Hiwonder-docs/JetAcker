...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image49.jpeg" style="width:500px" />
...
The JetAcker robot offers comprehensive ROS main controller support, with similar usage methods across the different controllers. The Raspberry Pi 5 uses the Debian 12 system, while the Jetson series uses the Ubuntu system. 
