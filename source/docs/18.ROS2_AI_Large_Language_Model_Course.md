...
Refer to [**18.1.1 Configure the Large Model API Key**](#anchor_18_1_1) to obtain the large model API-KEY: paste the vision model (from the OpenRouter website) into the vllm_api_key parameter, and the LLM model (from the OpenAI website) into the llm_api_key parameter, as indicated by the red boxes in the figure below.
...
Refer to [**18.2.1 Obtain and Configure the Large Model API Key**](#anchor_18_2_1) to obtain the large-model API-KEY: paste the vision model (from the OpenRouter website) into the vllm_api_key parameter, and the LLM model (from the OpenAI website) into the llm_api_key parameter, as indicated by the red boxes in the figure below.
...
Before enabling this feature, a map must be created in advance. Please refer to **"[13. ROS2+ Mapping and Navigation](https://wiki.hiwonder.com/projects/JetAcker/en/jetacker-jetson-nano/docs/13.ROS2_Mapping_%26_Navigation_Course.html)"** for detailed instructions on how to build the map.
