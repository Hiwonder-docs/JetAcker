...
1)  Extract the virtual machine software package saved in ‘**[Appendix-> Virtual Machine Installation Pack]()**’.
...
2)  In the popup window, locate the image file under the directory "**[Appendix-> 6-Channel Microphone Array Image]()**". Open the image file (the actual name of the image may vary; this image is for reference only).
...
1)  Connect the microphone array to the computer according to section ‘**[16.1.2 Testing the Microphone via Serial Port->Wiring]()**’.
...
1)  Start the virtual machine. Regarding the configuration and installation method of the virtual machine, please refer to the section ‘**[16.1.3 Virtual Machine Installation and Configuration]()**’
...
6)  Once opened, users should connect the wires to the **SPK-** and **SPK+** ports correctly. Since the speaker is mono, you can test it by selecting 'Front Right.' For detailed information on wiring connections, please refer to **[16.1.2 Testing the Microphone via Serial Port-> Wiring]()** '"
...
2. The default system wake word is "**hello hiwonder**" in English. To switch to Chinese or flashing command words, please refer to the document under the directory of “**[Voice Interaction Applications\Manuals\Switching Wake Words Between Chinese and English]()**” for instructions.
...
3\) If the above preparations have not been completed, please refer to the **"[1.6 Development Environment Setup and Configuration]()"** directory for instructions on how to apply for an APPID and replace the files.
...
The color recognition section uses the Lab color space to identify the color of objects. For a detailed explanation of the Lab color space, please refer to “**[14.ROS+OpenCV Course]()**.”
...
>
> * If the recognition result is inaccurate, you need to adjust the color threshold according to the instructions provided in ‘**[14. ROS+OpenCV Course]()**’.
...
3) If the above preparations have not been completed, please refer to the "**[16.3.1 6-Channel Microphone Array Configuration (Must Read)]()**" directory for instructions on how to apply for an APPID and replace the files.
...
4)  Construct a map of the area where the robot is currently located. If you need guidance on how to build a map, refer to the documents under the "**[13.ROS2+Mapping & Navigation Course]()**" section.
